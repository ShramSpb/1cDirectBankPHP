...
class DirectBank1C {
	...
	var $docKinds = ['01' => 'Извещение о состоянии обработки транспортного контейнера', '02' => 'Извещение о состоянии электронного документа', '03' => 'Запрос о состоянии электронного документа', '04' => 'Запрос об отзыве электронного документа', '05' => 'Запрос-зонд', '06' => 'Настройки обмена с банком', '10' => 'Платежное поручение', '11' => 'Платежное требование', '12' => 'Инкассовое поручение', '13' => 'Внутренний банковский документ', '14' => 'Запрос выписки банка', '15' => 'Выписка банка', '16' => 'Мемориальный ордер', '17' => 'Платежный ордер', '18' => 'Банковский ордер', '19' => 'Список на открытие счетов по зарплатному проекту', '20' => 'Подтверждение открытия счетов по зарплатному проекту', '21' => 'Список на зачисление денежных средств на счета сотрудников', '22' => 'Подтверждение зачисления денежных средств на счета сотрудников', '23' => 'Список уволенных сотрудников', '24' => 'Объявление на взнос наличными', '25' => 'Денежный чек', '30' => 'Поручение на перевод валюты', '35' => 'Выписка по валютному счету', '40' => 'Письмо'];

	/**
	 * Конструктор объекта
	 * @param string $setting_file файл с настройками
	 */
	public function __construct($password = '', $setting_file = "") {
		if ($setting_file)	{
